...
bar_graph <- function(future1, future2, variable){
  ...
  ggsave(here::here(paste(SiteID, "_month_", future1, "_", future2, "_", variable, "_c.png",sep="")), width = 15, height = 9)
