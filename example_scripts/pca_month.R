...
pca_month <- pca_thresholds("BAND", pca_data = pca_data, all_data = thresholds,  summarize_by = "month", directory = my_directory)
...
bar_graph <- function(future1, future2, variable){
  ...
  ggsave(here::here(paste(SiteID, "_month_", future1, "_", future2, "_", variable, "_pca.png",sep="")), width = 15, height = 9)
