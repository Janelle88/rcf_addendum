...
HistTmaxHigh = quantile(Baseline_all$TmaxCustom, 0.95)
HistTminLow = quantile(Baseline_all$TminCustom, 0.05)
...
past_data <- Baseline_all %>%
  dplyr::rename(rhmax = RHmaxCustom,
         ...
         temp_over_95_pctl_length = HeatConsecutive,
         temp_under_freeze = UnderColdTemp,
         temp_under_freeze_length = ColdConsecutive,
